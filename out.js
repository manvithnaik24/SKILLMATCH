...
var require_countUp_umd = __commonJS({
  "node_modules/countup.js/dist/countUp.umd.js"(exports, module2) {
    !(function(t, e) {
      "object" == typeof exports && "undefined" != typeof module2 ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).countUp = {});
    })(exports, (function(t) {
      "use strict";
      var e = function() {
...
var require_build = __commonJS({
  "node_modules/react-countup/build/index.js"(exports) {
    ...
    var useIsomorphicLayoutEffect2 = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? React3.useLayoutEffect : React3.useEffect;
    ...
    var useCountUp = function useCountUp2(props) {
      ...
      var _useMemo = React3.useMemo(function() {
      ...
      var countUpRef = React3.useRef();
      var timerRef = React3.useRef();
      var isInitializedRef = React3.useRef(false);
...
// src/components/student/AnalyticsPanel.jsx
...
function AnalyticsPanel({ applications }) {
  ...
  const avgMatch = total > 0 ? Math.round(applications.reduce((acc, a) => acc + (a.matchScore || 0), 0) / total) : 0;
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "absolute -right-6 -top-6 bg-white/10 w-24 h-24 rounded-full blur-xl group-hover:bg-white/20 transition-all duration-500" }),
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-semibold text-white/90" }, "Total Applications"), /* @__PURE__ */ React.createElement("div", { className: "p-2 bg-white/20 rounded-xl" }, /* @__PURE__ */ React.createElement(FileText, { className: "w-5 h-5 text-white" }))),
      /* @__PURE__ */ React.createElement("p", { className: "text-4xl font-bold tracking-tight" }, /* @__PURE__ */ React.createElement(import_react_countup.default, { end: total, duration: 2 }))
    ),
    /* @__PURE__ */ React.createElement(
      motion.div,
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "absolute top-0 right-0 w-16 h-16 bg-blue-50 rounded-bl-full -z-10 group-hover:scale-150 transition-transform duration-500" }),
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-semibold text-slate-500" }, "Shortlisted"), /* @__PURE__ */ React.createElement("div", { className: "p-2 bg-blue-50 rounded-xl" }, /* @__PURE__ */ React.createElement(CircleCheckBig, { className: "w-5 h-5 text-blue-600" }))),
      /* @__PURE__ */ React.createElement("p", { className: "text-4xl font-bold tracking-tight text-slate-900" }, /* @__PURE__ */ React.createElement(import_react_countup.default, { end: shortlisted, duration: 2.5 }))
    ),
    /* @__PURE__ */ React.createElement(
      motion.div,
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "absolute -left-6 -bottom-6 bg-white/20 w-24 h-24 rounded-full blur-xl group-hover:bg-white/30 transition-all duration-500" }),
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-semibold text-white/90" }, "Avg Match Score"), /* @__PURE__ */ React.createElement("div", { className: "p-2 bg-white/20 rounded-xl" }, /* @__PURE__ */ React.createElement(TrendingUp, { className: "w-5 h-5 text-white" }))),
      /* @__PURE__ */ React.createElement("p", { className: "text-4xl font-bold tracking-tight" }, /* @__PURE__ */ React.createElement(import_react_countup.default, { end: avgMatch, duration: 2 }), "%")
    ),
    /* @__PURE__ */ React.createElement(
      motion.div,
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "absolute top-0 right-0 w-16 h-16 bg-slate-50 rounded-bl-full -z-10 group-hover:scale-150 transition-transform duration-500" }),
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-semibold text-slate-500" }, "Pending Response"), /* @__PURE__ */ React.createElement("div", { className: "p-2 bg-slate-50 rounded-xl" }, /* @__PURE__ */ React.createElement(Clock, { className: "w-5 h-5 text-slate-600" }))),
      /* @__PURE__ */ React.createElement("p", { className: "text-4xl font-bold tracking-tight text-slate-900" }, /* @__PURE__ */ React.createElement(import_react_countup.default, { end: total - shortlisted, duration: 2 }))
    )
  );
}
...
// test-render.jsx
try {
  (0, import_server.renderToString)(/* @__PURE__ */ import_react23.default.createElement(AnalyticsPanel, { applications: [] }));
  console.log("Success");
} catch (e) {
